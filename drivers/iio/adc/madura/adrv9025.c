...
static int __adrv9025_of_get_u32(struct device_node *np, const char *propname,
...
#define ADRV9025_OF_PROP(_dt_name, _member_, _default) \
	__adrv9025_of_get_u32(np, _dt_name, _default, _member_, sizeof(*_member_))
...
static int adrv9025_phy_parse_agc_dt(struct iio_dev *iodev, struct device *dev)
{
	...
	ADRV9025_OF_PROP("adi,rxagc-peak-agc-under-range-low-interval",
			 &phy->agcConfig->agcPeak.agcUnderRangeLowInterval, 1229);
	ADRV9025_OF_PROP("adi,rxagc-peak-agc-under-range-mid-interval",
			 &phy->agcConfig->agcPeak.agcUnderRangeMidInterval, 4);
	ADRV9025_OF_PROP("adi,rxagc-peak-agc-under-range-high-interval",
			 &phy->agcConfig->agcPeak.agcUnderRangeHighInterval, 4);
	ADRV9025_OF_PROP("adi,rxagc-peak-apd-high-thresh",
			 &phy->agcConfig->agcPeak.apdHighThresh, 42);
	ADRV9025_OF_PROP("adi,rxagc-peak-apd-low-gain-mode-high-thresh",
			 &phy->agcConfig->agcPeak.apdLowGainModeHighThresh, 0);
	ADRV9025_OF_PROP("adi,rxagc-peak-apd-low-thresh",
			 &phy->agcConfig->agcPeak.apdLowThresh, 30);
	ADRV9025_OF_PROP("adi,rxagc-peak-apd-low-gain-mode-low-thresh",
			 &phy->agcConfig->agcPeak.apdLowGainModeLowThresh, 0);
	ADRV9025_OF_PROP("adi,rxagc-peak-apd-upper-thresh-peak-exceeded-cnt",
			 &phy->agcConfig->agcPeak.apdUpperThreshPeakExceededCnt, 3);
	ADRV9025_OF_PROP("adi,rxagc-peak-apd-lower-thresh-peak-exceeded-cnt",
			 &phy->agcConfig->agcPeak.apdLowerThreshPeakExceededCnt, 3);
	ADRV9025_OF_PROP("adi,rxagc-peak-apd-gain-step-attack",
			 &phy->agcConfig->agcPeak.apdGainStepAttack, 4);
	ADRV9025_OF_PROP("adi,rxagc-peak-apd-gain-step-recovery",
			 &phy->agcConfig->agcPeak.apdGainStepRecovery, 0);
	ADRV9025_OF_PROP("adi,rxagc-peak-enable-hb2-overload",
			 &phy->agcConfig->agcPeak.enableHb2Overload, 1);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-overload-duration-cnt",
			 &phy->agcConfig->agcPeak.hb2OverloadDurationCnt, 2);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-overload-thresh-cnt",
			 &phy->agcConfig->agcPeak.hb2OverloadThreshCnt, 1);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-high-thresh",
			 &phy->agcConfig->agcPeak.hb2HighThresh, 10388);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-under-range-low-thresh",
			 &phy->agcConfig->agcPeak.hb2UnderRangeLowThresh, 64);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-under-range-mid-thresh",
			 &phy->agcConfig->agcPeak.hb2UnderRangeMidThresh, 102);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-under-range-high-thresh",
			 &phy->agcConfig->agcPeak.hb2UnderRangeHighThresh, 128);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-upper-thresh-peak-exceeded-cnt",
			 &phy->agcConfig->agcPeak.hb2UpperThreshPeakExceededCnt, 3);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-under-range-high-thresh-exceeded-cnt",
			 &phy->agcConfig->agcPeak.hb2UnderRangeHighThreshExceededCnt, 3);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-gain-step-high-recovery",
			 &phy->agcConfig->agcPeak.hb2GainStepHighRecovery, 2);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-gain-step-low-recovery",
			 &phy->agcConfig->agcPeak.hb2GainStepLowRecovery, 8);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-gain-step-mid-recovery",
			 &phy->agcConfig->agcPeak.hb2GainStepMidRecovery, 4);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-gain-step-attack",
			 &phy->agcConfig->agcPeak.hb2GainStepAttack, 4);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-overload-power-mode",
			 &phy->agcConfig->agcPeak.hb2OverloadPowerMode, 1);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-thresh-config",
			 &phy->agcConfig->agcPeak.hb2ThreshConfig, 3);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-under-range-mid-thresh-exceeded-cnt",
			 &phy->agcConfig->agcPeak.hb2UnderRangeMidThreshExceededCnt, 3);
	ADRV9025_OF_PROP("adi,rxagc-peak-hb2-under-range-low-thresh-exceeded-cnt",
			 &phy->agcConfig->agcPeak.hb2UnderRangeLowThreshExceededCnt, 3);

	ADRV9025_OF_PROP("adi,rxagc-power-power-enable-measurement",
			 &phy->agcConfig->agcPower.powerEnableMeasurement, 1);
	ADRV9025_OF_PROP("adi,rxagc-power-power-input-select",
			 &phy->agcConfig->agcPower.powerInputSelect, 2);
	ADRV9025_OF_PROP("adi,rxagc-power-under-range-high-power-thresh",
			 &phy->agcConfig->agcPower.underRangeHighPowerThresh, 13);
	ADRV9025_OF_PROP("adi,rxagc-power-under-range-low-power-thresh",
			 &phy->agcConfig->agcPower.underRangeLowPowerThresh, 4);
	ADRV9025_OF_PROP("adi,rxagc-power-under-range-high-power-gain-step-recovery",
			 &phy->agcConfig->agcPower.underRangeHighPowerGainStepRecovery, 4);
	ADRV9025_OF_PROP("adi,rxagc-power-under-range-low-power-gain-step-recovery",
			 &phy->agcConfig->agcPower.underRangeLowPowerGainStepRecovery, 4);
	ADRV9025_OF_PROP("adi,rxagc-power-power-measurement-duration",
			 &phy->agcConfig->agcPower.powerMeasurementDuration, 5);
	ADRV9025_OF_PROP("adi,rxagc-power-rx-tdd-power-meas-duration",
			 &phy->agcConfig->agcPower.rxTddPowerMeasDuration, 31661);
	ADRV9025_OF_PROP("adi,rxagc-power-rx-tdd-power-meas-delay",
			 &phy->agcConfig->agcPower.rxTddPowerMeasDelay, 54098);
	ADRV9025_OF_PROP("adi,rxagc-power-over-range-high-power-thresh",
			 &phy->agcConfig->agcPower.overRangeHighPowerThresh, 10);
	ADRV9025_OF_PROP("adi,rxagc-power-over-range-low-power-thresh",
			 &phy->agcConfig->agcPower.overRangeLowPowerThresh, 2);
	ADRV9025_OF_PROP("adi,rxagc-power-power-log-shift",
			 &phy->agcConfig->agcPower.powerLogShift, 1);
	ADRV9025_OF_PROP("adi,rxagc-power-over-range-high-power-gain-step-attack",
			 &phy->agcConfig->agcPower.overRangeHighPowerGainStepAttack, 4);
	ADRV9025_OF_PROP("adi,rxagc-power-over-range-low-power-gain-step-attack",
			 &phy->agcConfig->agcPower.overRangeLowPowerGainStepAttack, 4);

	ADRV9025_OF_PROP("adi,rxagc-rx-channel-mask",
			 &phy->agcConfig->rxChannelMask, 0x0F);
	ADRV9025_OF_PROP("adi,rxagc-agc-peak-wait-time",
			 &phy->agcConfig->agcPeakWaitTime, 4);
	ADRV9025_OF_PROP("adi,rxagc-agc-rx-max-gain-index",
			 &phy->agcConfig->agcRxMaxGainIndex, 255);
	ADRV9025_OF_PROP("adi,rxagc-agc-rx-min-gain-index",
			 &phy->agcConfig->agcRxMinGainIndex, 183);
	ADRV9025_OF_PROP("adi,rxagc-agc-gain-update-counter",
			 &phy->agcConfig->agcGainUpdateCounter, 245760);
	ADRV9025_OF_PROP("adi,rxagc-agc-rx-attack-delay",
			 &phy->agcConfig->agcRxAttackDelay, 10);
	ADRV9025_OF_PROP("adi,rxagc-agc-slow-loop-settling-delay",
			 &phy->agcConfig->agcSlowLoopSettlingDelay, 16);
	ADRV9025_OF_PROP("adi,rxagc-agc-low-thresh-prevent-gain-inc",
			 &phy->agcConfig->agcLowThreshPreventGainInc, 1);
	ADRV9025_OF_PROP("adi,rxagc-agc-change-gain-if-thresh-high",
			 &phy->agcConfig->agcChangeGainIfThreshHigh, 3);
	ADRV9025_OF_PROP("adi,rxagc-agc-peak-thresh-gain-control-mode",
			 &phy->agcConfig->agcPeakThreshGainControlMode, 1);
	ADRV9025_OF_PROP("adi,rxagc-agc-reset-on-rxon",
			 &phy->agcConfig->agcResetOnRxon, 0);
	ADRV9025_OF_PROP("adi,rxagc-agc-enable-sync-pulse-for-gain-counter",
			 &phy->agcConfig->agcEnableSyncPulseForGainCounter, 0);
	ADRV9025_OF_PROP("adi,rxagc-agc-enable-fast-recovery-loop",
			 &phy->agcConfig->agcEnableFastRecoveryLoop, 0);
	ADRV9025_OF_PROP("adi,rxagc-agc-adc-reset-gain-step",
			 &phy->agcConfig->agcAdcResetGainStep, 0);
	ADRV9025_OF_PROP("adi,rxagc-agc-slow-loop-fast-gain-change-block-enable",
			 &phy->agcConfig->agcSlowloopFastGainChangeBlockEnable, 0);
...
static int adrv9025_probe(struct spi_device *spi)
{
	...
	agcConfig = kzalloc(sizeof(adi_adrv9025_AgcCfg_t), GFP_KERNEL);
	if (!agcConfig)
		return -ENOMEM;
